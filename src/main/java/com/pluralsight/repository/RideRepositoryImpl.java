...
public class RideRepositoryImpl implements RideRepository {
	...
	public Ride createRide(Ride ride) {
		...
		// 1 maneira
		//jdbcTemplate.update("insert into ride (name, durantion) values (?,?)", ride.getName(), ride.getDuration());
		 ...
		 * con.prepareStatement("insert into ride (name, durantion) values (?,?)", new
